...
export default function ConstructionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/service-request', {
        ...
        body: JSON.stringify({ ...formData, serviceName: 'الإنشاءات والمقاولات' })
      })
  ...
  const services = [
    {
      name: "البناء من الأساس",
      description: "إنشاء المباني السكنية والتجارية من البداية",
      price: "من 1,200 جنيه/متر"
    },
    {
      name: "التوسعات والإضافات", 
      description: "توسيع المباني الحالية وإضافة طوابق جديدة",
      price: "من 800 جنيه/متر"
    },
    {
      name: "الترميم والصيانة",
      description: "ترميم وصيانة المباني القديمة",
      price: "حسب نوع العمل"
    }
  ]
  ...
  const why_choose = [
    "خبرة تزيد عن 20 سنة في مجال البناء",
    "فريق من المهندسين المعتمدين",
  ...
  const process = [
    {
      ...
      description: "دراسة الموقع ووضع التصميم المناسب"
    },
    {
      step: "2",
      title: "الحصول على التراخيص",
      description: "استخراج جميع التراخيص المطلوبة"
    },
    {
      step: "3",
      title: "بداية التنفيذ",
      description: "البدء في أعمال الحفر والأساسات"
    },
    {
      step: "4",
      title: "التسليم النهائي",
      description: "إنجاز المشروع وتسليمه مع الضمانات"
    }
  ]
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <motion.div
              ...
              className="inline-flex items-center justify-center w-20 h-20 bg-orange-600 rounded-full mb-6"
            >
            ...
            >
              تنفيذ خرسانات ومباني وأعمال الإنشاءات بأعلى معايير الجودة والالتزام بالمواعيد
            </motion.p>
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            >
              <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                <CheckIcon className="w-6 h-6 text-orange-600 ml-3" />
                مميزات الخدمة
              </h2>
              <div className="grid md:grid-cols-2 gap-4">
                {features.map((feature, index) => (
                  ...
                  >
                    <CheckIcon className="w-5 h-5 text-orange-600 ml-3 flex-shrink-0" />
              ...
              <div className="space-y-6">
                {services.map((service, index) => (
                  <motion.div
                    ...
                    transition={{ duration: 0.5, delay: index * 0.1 }} viewport={{ once: true }}
                    className="border-2 border-orange-200 rounded-lg p-6 hover:shadow-md transition-shadow"
                  >
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {why_choose.map((reason, index) => (
                  ...
                  >
                    <div className="w-2 h-2 bg-orange-600 rounded-full ml-3 flex-shrink-0" />
            ...
            >
              ...
              <div className="relative">
                {process.map((step, index) => (
                  ...
                  >
                    <div className="flex items-center justify-center w-12 h-12 bg-orange-600 text-white rounded-full font-bold text-lg ml-4 flex-shrink-0">
                      {step.step}
                    </div>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-orange-600 text-white py-3 px-4 rounded-md hover:bg-orange-700 transition-colors flex items-center justify-center disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
