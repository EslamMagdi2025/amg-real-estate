...
export default function FinishingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/service-request', {
        ...
        body: JSON.stringify({ ...formData, serviceName: 'التشطيبات والديكورات' })
      })
  ...
  const services = [
    {
      ...
      description: "تشطيب شامل للشقق والفيلات",
      price: "من 400 جنيه/متر"
    },
    {
      name: "التشطيب الخارجي",
      description: "واجهات وأعمال خارجية متنوعة",
      price: "من 300 جنيه/متر"
    },
    {
      name: "الديكور والتصميم",
      description: "تصميم داخلي وتنسيق الأثاث",
      price: "من 50,000 جنيه"
    }
  ]
  ...
  const why_choose = [
    "مصممون داخليون معتمدون",
    "خامات عالية الجودة ومضمونة",
    "تنوع في الأساليب والتصاميم",
    "فريق عمل ماهر ومدرب",
  ...
  const process = [
    {
      ...
      description: "مناقشة الرؤية ووضع التصميم المناسب"
    },
    {
      step: "2",
      title: "اختيار المواد",
      description: "اختيار أفضل المواد والخامات"
    },
    {
      step: "3",
      title: "التنفيذ",
      description: "البدء في أعمال التشطيب"
    },
    {
      step: "4",
      title: "التسليم النهائي",
      description: "مراجعة نهائية وتسليم العمل"
    }
  ]
      ...
      <div className="relative h-[60vh] min-h-[400px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            >
              تشطيبات داخلية وخارجية عالية الجودة مع تصاميم عصرية ومواد فاخرة
            </motion.p>
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            >
              <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                <CheckIcon className="w-6 h-6 text-purple-600 ml-3" />
                مميزات الخدمة
              </h2>
              <div className="grid md:grid-cols-2 gap-4">
                {features.map((feature, index) => (
                  ...
                  >
                    <CheckIcon className="w-5 h-5 text-purple-600 ml-3 flex-shrink-0" />
              ...
              <div className="space-y-6">
                {services.map((service, index) => (
                  <motion.div
                    ...
                    transition={{ duration: 0.5, delay: index * 0.1 }} viewport={{ once: true }}
                    className="border-2 border-purple-200 rounded-lg p-6 hover:shadow-md transition-shadow"
                  >
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {why_choose.map((reason, index) => (
                  ...
                  >
                    <div className="w-2 h-2 bg-purple-600 rounded-full ml-3 flex-shrink-0" />
            ...
            >
              ...
              <div className="relative">
                {process.map((step, index) => (
                  ...
                  >
                    <div className="flex items-center justify-center w-12 h-12 bg-purple-600 text-white rounded-full font-bold text-lg ml-4 flex-shrink-0">
                      {step.step}
                    </div>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-purple-600 text-white py-3 px-4 rounded-md hover:bg-purple-700 transition-colors flex items-center justify-center disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
