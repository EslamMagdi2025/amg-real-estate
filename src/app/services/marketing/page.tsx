...
export default function RealEstateMarketingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/service-request', {
        ...
        body: JSON.stringify({ ...formData, serviceName: 'التسويق العقاري' })
      })
  ...
  const services = [
    {
      ...
      description: "تصوير عقارك بأحدث المعدات والتقنيات",
      price: "من 2,000 جنيه"
    },
    {
      name: "الحملات الإعلانية",
      description: "إعلانات مدفوعة على منصات متعددة",
      price: "من 5,000 جنيه"
    },
    {
      name: "إدارة التسويق الكاملة",
      description: "إدارة شاملة لعملية التسويق من البداية للنهاية",
      price: "عمولة 2.5%"
    }
  ]
  ...
  const features = [
    ...
    "تصوير احترافي عالي الجودة",
    "إعلانات رقمية مستهدفة"
  ]

  const why_choose = [
    "فريق تسويق متخصص ومحترف",
    "استخدام أحدث تقنيات التسويق الرقمي",
    "قاعدة بيانات عملاء ضخمة",
    "نتائج مضمونة في وقت قياسي",
    "أسعار تنافسية وعروض مرنة",
    "متابعة مستمرة حتى إتمام البيع"
  ]
  ...
  const process = [
    {
      step: "1",
      title: "تقييم العقار",
      description: "دراسة شاملة للعقار وتحديد السعر الأمثل"
    },
    {
      step: "2",
      title: "التصوير والإعداد",
      description: "تصوير احترافي وإعداد المواد التسويقية"
    },
    {
      step: "3",
      title: "إطلاق الحملة",
      description: "نشر الإعلانات على جميع المنصات"
    },
    {
      step: "4",
      title: "المتابعة والبيع",
      description: "متابعة العملاء المهتمين وإتمام الصفقة"
    }
  ]
      ...
      <div className="relative h-[60vh] min-h-[400px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            >
              تسويق وتطوير المشاريع العقارية المتميزة والمجمعات السكنية والتجارية
            </motion.p>
          </div>
        </div>
      </div>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {features.map((feature, index) => (
                  ...
                  >
                    <CheckIcon className="w-5 h-5 text-green-600 ml-3 flex-shrink-0" />
              ...
              <div className="space-y-6">
                {services.map((service, index) => (
                  <motion.div
                    ...
                    transition={{ duration: 0.5, delay: index * 0.1 }} viewport={{ once: true }}
                    className="border-2 border-green-200 rounded-lg p-6 hover:shadow-md transition-shadow"
                  >
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {why_choose.map((reason, index) => (
                  ...
                  >
                    <div className="w-2 h-2 bg-green-600 rounded-full ml-3 flex-shrink-0" />
            ...
            >
              ...
              <div className="relative">
                {process.map((step, index) => (
                  ...
                  >
                    <div className="flex items-center justify-center w-12 h-12 bg-green-600 text-white rounded-full font-bold text-lg ml-4 flex-shrink-0">
                      {step.step}
                    </div>
