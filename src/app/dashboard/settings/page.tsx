  ...
  const handleUpdateNotifications = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert('حدث خطأ في تحديث إعدادات الإشعارات')
      }
    } catch (error) {
          ...
          <div className="lg:col-span-1">
            ...
            >
              <div className="space-y-2">
                ...
                >
                  <div className="flex items-center">
                    <BellIcon className="w-5 h-5 ml-3" />
            ...
            {activeTab === 'notifications' && (
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div>
                      <h3 className="font-medium text-gray-900">استفسارات جديدة</h3>
                      <p className="text-sm text-gray-500">إشعارات عند وصول استفسارات جديدة على عقاراتك</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div>
                      <h3 className="font-medium text-gray-900">مشاهدات العقارات</h3>
                      <p className="text-sm text-gray-500">إشعارات عند مشاهدة عقاراتك</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        onChange={(e) => setNotificationSettings({
                          ...notificationSettings,
                          propertyViews: e.target.checked
                        })}
                        className="sr-only peer"
                      />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div>
                      <h3 className="font-medium text-gray-900">رسائل تسويقية</h3>
                      <p className="text-sm text-gray-500">تلقي رسائل تسويقية وعروض خاصة</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
